...
const BillCards = ({ bill }) => {
  return (
    ...
    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-slate-700">{bill.senderName}</h5>
    ...
    <div className="mb-3 p-3 bg-blue-50 dark:bg-gray-700 rounded-lg">
      <p className="font-normal text-gray-700 dark:text-gray-300"><span className="font-semibold">From:</span> {bill.senderAddress}</p>
      <p className="font-normal text-gray-700 dark:text-gray-300"><span className="font-semibold">To:</span> {bill.receiverAddress}</p>
    </div>
    <div className="mb-3 p-3 bg-green-50 dark:bg-gray-700 rounded-lg">
      <p className="font-normal text-gray-700 dark:text-gray-300"><span className="font-semibold">Receiver:</span> {bill.receiverName}</p>
      <p className="font-normal text-gray-700 dark:text-gray-300"><span className="font-semibold">Distance:</span> {bill.distanceCovered} km</p>
    </div>
