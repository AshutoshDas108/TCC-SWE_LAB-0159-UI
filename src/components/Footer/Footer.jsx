            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-6 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-700 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/AshutoshDas108"
                                ...
                                <li>
                                    <Link to="https://www.linkedin.com/in/ashutosh-das-59058124a/" className="hover:underline">
                                        LinkedIn
                                    </Link>
                                </li>
                            </ul>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-700 sm:text-center">
                        © 2024 
                        <a href="https://www.linkedin.com/in/ashutosh-das-59058124a/" className="hover:underline">
                           @AshutoshDas
                        </a>
                        . All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <Link to="https://github.com/AshutoshDas108" className="text-gray-700">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
