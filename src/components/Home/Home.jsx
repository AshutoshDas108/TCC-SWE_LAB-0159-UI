      ...
      <div className='text-4xl bg-slate-700 text-white text-center font-bold p-4'>
        ...
        <div className="mx-auto w-full max-w-7xl">
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                <div className="relative z-10 max-w-screen-xl px-4  pb-20 pt-5 sm:py-24 mx-auto sm:px-6 lg:px-8">
                ...
                <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full ">
                    <img className="w-96 h-90" src="https://i.ibb.co/5BCcDYB/Remote2.png" alt="image1" />
                </div>
            </aside>
            ...
            <h1 className="text-center text-xl sm:text-5xl py-10 font-medium">Get fast and reliable delivery...</h1>
        </div>
    </div>
